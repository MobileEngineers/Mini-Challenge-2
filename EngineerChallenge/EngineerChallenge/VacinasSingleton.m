...
- (id) init
{
    ...
    [_vacinasDetalhes addObject:@{@"nome":@"Hepatite B",    @"doenca":@"Hepatite B",    @"contraInd":@"Gravidez risco C, histórico de hipersensibilidade aos componentes da vacina, incluindo leveduras, doença aguda moderada a grave",    @"efeitoCol":@"Dor de cabeça, fadiga, febre, tontura, calor, desconforto, edema, enduração, formação de nódulo inflamação avermelhada na pele",     @"idade":@"Ao Nascer",      @"doses":@1 }];
     ...
     [_vacinasDetalhes addObject:@{@"nome":@"Rotavírus",     @"doenca":@"diarréia por rotavírus",    @"contraInd":@"Se seu filho tiver com febre alta, pode ser necessário adiar a vacinação até a recuperação e se sofre de problemas do estômago ou do intestino a vacinação deve ser considerada com cautela",   @"efeitoCol":@"",       @"idade":@"2º e 4º mês",  @"doses":@2 }];
     
    [_vacinasDetalhes addObject:@{@"nome":@"Pneumo 10",     @"doenca":@"Pneumonia, otite, meningite e outras doenças causadas pelo Pneumococos",            @"contraInd":@"Não deve ser administrada a crianças com hipersensibilidade conhecida após administração prévia ou a qualquer um dos componentes da vacina. Febre alta também é um motivo para adiar a vacinação",   @"efeitoCol":@"Sonolência, perda de apetite, dor, vermelhidão e inchaço no local da injeção, febre e irritabilidade",       @"idade":@"2º, 4º, 6º e 12º mês",   @"doses":@4 }];
     
     [_vacinasDetalhes addObject:@{@"nome":@"Meningo C",     @"doenca":@"Meningite causada por Neisseria meningitidis do sorogrupo C",   @"contraInd":@"Crianças com imunodeficiência congênita ou adquirida, uma neoplasia maligna e tratamento com corticoides a mais de 2 mg por quilo ao dia",       @"efeitoCol":@"Rubor, edema, endurecimento e hipersensibilidade/dor na região em que a vacina foi aplicada. Em crianças menores há relatos de febre, choro, irritabilidade, sonolência ou comprometimento do sono, anorexia, diarréia e vômitos",       @"idade":@"3º, 5º e 15º mês",   @"doses":@3 }];
     ...
     [_vacinasDetalhes addObject:@{@"nome":@"Hepatite A",    @"doenca":@"Hepatite A",      @"contraInd":@"Pessoas com febre ou com hipersensibilidade (alergia) conhecida a alguns dos seus componentes, ou em indivíduos que já tiveram hepatite A",         @"efeitoCol":@"Fadiga, mal estar, dores de cabeça, insónia, vertigens, falta de apetite, náuseas, vómitos, diarreia, dor abdominal, dores musculares e articulares, queixas respiratórias, alterações da pele (urticária, inchaço, hematoma e vermelhidão no local da injecção) e febre",       @"idade":@"12º mês",    @"doses":@1 }];
